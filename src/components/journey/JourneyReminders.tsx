  ...
  return (
    <div className="w-full space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
        <div>
          <h2 className="font-display text-2xl sm:text-3xl font-bold text-white flex items-center gap-2.5">
            <Bell className="w-6 h-6" style={{ color: goldPrimary }} />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
        ...
        <div className="p-5 sm:p-6 rounded-2xl bg-[#0e0e13] border border-zinc-800 flex flex-col justify-between space-y-4">
          <div>
            <div className="flex items-center justify-between text-xs sm:text-sm font-mono text-zinc-300">
              ...
              <span className="px-2.5 py-0.5 rounded bg-zinc-800 text-zinc-300 text-xs font-semibold">Rotina</span>
            </div>
              ...
              {isEditingTime ? (
                <div className="flex items-center gap-2 mt-1">
                  <input
                    ...
                    className="px-3 py-1.5 rounded-lg bg-zinc-900 border border-zinc-700 text-white font-mono text-base"
                  />
                  <button
                    onClick={handleSaveTime}
                    className="px-3 py-1.5 rounded-lg bg-emerald-600 text-white text-xs sm:text-sm font-bold"
                  >
                    Salvar
                  </button>
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs sm:text-sm text-zinc-300 mt-0.5">Tomar 1 dose de 450mg</p>
                  </div>
                  <button
          ...
          <div className="pt-3 border-t border-zinc-800 text-xs sm:text-sm text-zinc-400 flex items-center justify-between">
        ...
        <div className="p-5 sm:p-6 rounded-2xl bg-[#0e0e13] border border-zinc-800 flex flex-col justify-between space-y-4">
          <div>
            <div className="flex items-center justify-between text-xs sm:text-sm font-mono text-zinc-300">
              ...
              <span className="px-2.5 py-0.5 rounded bg-zinc-800 text-zinc-300 text-xs font-semibold">Evolução</span>
            </div>
            ...
            <div className="mt-3">
              ...
              <p className="text-xs sm:text-sm text-zinc-300 mt-0.5">Registro fotográfico do mês</p>
            </div>
          </div>
        ...
        <div className="p-5 sm:p-6 rounded-2xl bg-[#0e0e13] border border-zinc-800 flex flex-col justify-between space-y-4">
          <div>
            <div className="flex items-center justify-between text-xs sm:text-sm font-mono text-zinc-300">
              ...
              <span className={`px-2.5 py-0.5 rounded text-xs font-bold ${isLowSupply ? 'bg-rose-950 text-rose-300 border border-rose-800' : 'bg-zinc-800 text-zinc-300'}`}>
            ...
            <div className="mt-3 space-y-2">
              <div className="flex items-baseline justify-between">
                ...
                <span className="text-xs sm:text-sm font-mono text-zinc-400">de {profile.totalDoses}</span>
              </div>
          ...
          <div className="pt-3 border-t border-zinc-800 flex items-center justify-between text-xs sm:text-sm">
            <span className="text-zinc-400">Previsão: {profile.refillDate}</span>
            <button
              onClick={onNavigateToGallery}
              className="text-amber-400 hover:underline font-bold flex items-center gap-1 cursor-pointer"
            >
              Repor frasco <ExternalLink className="w-3.5 h-3.5" />
            </button>
          </div>
        </div>
        ...
        <div className="p-5 sm:p-6 rounded-2xl bg-[#0e0e13] border border-zinc-800 flex flex-col justify-between space-y-4">
          <div>
            <div className="flex items-center justify-between text-xs sm:text-sm font-mono text-zinc-300">
              ...
              <span className="px-2.5 py-0.5 rounded bg-zinc-800 text-zinc-300 text-xs font-semibold">Gratuito</span>
            </div>
            ...
            <div className="mt-3">
              ...
              <p className="text-xs sm:text-sm text-zinc-300 mt-0.5">Revisão com tricologista</p>
            </div>
          </div>

          <div className="pt-3 border-t border-zinc-800 flex items-center justify-between text-xs sm:text-sm">
            <span className="text-zinc-400">Canal: WhatsApp</span>
            <button
            ...
            >
              Agendar <ExternalLink className="w-3.5 h-3.5" />
            </button>
          </div>
        </div>
      ...
      {reminderSetToast && (
        <div className="p-3.5 rounded-xl bg-emerald-950/80 border border-emerald-800 text-emerald-300 text-xs sm:text-sm flex items-center gap-2 font-medium">
