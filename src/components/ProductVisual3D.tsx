...
export const ProductVisual3D: React.FC<ProductVisual3DProps> = ({
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute w-72 h-72 sm:w-96 sm:h-96 rounded-full blur-3xl opacity-20 pointer-events-none transition-colors duration-700"
        style={{
      ...
      >
        ...
        {variant === 'floating' && (
          <>
            ...
            >
              <div className="w-16 h-7 rounded-full shadow-2xl overflow-hidden flex border border-white/10"
                style={{
            ...
            <motion.div
              ...
              className="absolute top-36 -left-8 z-20"
            >
        ...
        {/* The Luxury Amber Glass Bottle */}
        <div className="relative w-56 sm:w-64 flex flex-col items-center">
          {/* Bottle Black Brushed Cap (Floating open in floating mode, or screwed in standing) */}
          <motion.div
            animate={{
              y: variant === 'floating' ? [-16, -24, -16] : 0,
              rotate: variant === 'floating' ? [-8, -14, -8] : 0,
              x: variant === 'floating' ? [12, 18, 12] : 0,
            }}
          ...
          {/* Bottle Body - Amber Glass & Texture */}
          <div
          ...
          >
            ...
            <div className="w-full my-auto px-2 py-1">
              ...
              >
                {/* Wave Line Art Pattern Background (inspired by actual product mockup) */}
                <svg
        ...
        {/* Standing Capsules on Surface (Variant Standing) */}
        {variant === 'standing' && (
          <div className="flex items-center justify-center gap-3 -mt-3 z-30">
            <motion.div
              whileHover={{ y: -4, scale: 1.05 }}
              className="w-16 h-7 rounded-full shadow-2xl overflow-hidden flex border border-white/10 bg-zinc-950 rotate-6 cursor-pointer"
            >
            ...
            <motion.div
              whileHover={{ y: -4, scale: 1.05 }}
              className="w-14 h-6 rounded-full shadow-2xl overflow-hidden flex border border-white/10 bg-zinc-950 -rotate-12 cursor-pointer"
            >
        ...
        {/* Floor Shadow */}
        <div
          className="w-48 sm:w-56 h-6 rounded-full blur-md opacity-70 -mt-2 pointer-events-none"
          style={{
